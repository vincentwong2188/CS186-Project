...
public class LockContext {
    ...
    public void removeChild(TransactionContext transaction, LockContext parent) {
        if (parent == null) {
            return;
        }
    ...
    throws InvalidLockException, DuplicateLockRequestException {
        ...
        if (this.parent == null) {
            ...
            lt = parent.getExplicitLockType(transaction);
        }

        if (LockType.substitutable(lt, LockType.parentLock(lt)) || lt == LockType.NL) {
    ...
    throws NoLockHeldException, InvalidLockException {
        ...
        removeChild(transaction, this.parent);
    }

    public void addToParent(TransactionContext transaction, LockContext parent) {
        if (parent == null) {
            return;
        }
    ...
    public LockType getEffectiveLockType(TransactionContext transaction) {
        ...
        if (locktype == LockType.NL && this.parent != null) {
            locktype = this.parent.getEffectiveLockType(transaction);
